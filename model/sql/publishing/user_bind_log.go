...
type OdsPublishingUserBindLogModel struct {
	...
	ChannelId int             `json:"channel_id" gorm:"column:channel_id;default:0;comment:发行渠道ID;uniqueIndex:ix_c_o;index:ix_c_u"`
	OpenId    string          `json:"open_id" gorm:"size:100;column:open_id;default:'';comment:发行渠道用户ID;uniqueIndex:ix_c_o"`
	UnionId   string          `json:"union_id" gorm:"size:100;column:union_id;default:'';comment:union_id;index:ix_c_u"`
