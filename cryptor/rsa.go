...
func RsaEncryptBase64(pubkey, data []byte) (string, error) {
	rsaResult, rsaErr := RsaEncrypt(pubkey, data)
	if rsaErr != nil {
		return "", rsaErr
	}
	return base64.StdEncoding.EncodeToString(rsaResult), nil
}
...
func RsaDecryptBase64(prvkey []byte, data string) ([]byte, error) {
	base64Data, base64Err := base64.StdEncoding.DecodeString(data)
	if base64Err != nil {
		return nil, base64Err
	}
	return RsaDecrypt(prvkey, base64Data)
}
