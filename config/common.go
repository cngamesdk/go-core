...
type CommonConfig struct {
	AccountPrefixs          []string `mapstructure:"account_prefixs" json:"account_prefixs" yaml:"account_prefixs"`                                  // 账号前缀列表
	TestPhones              []string `mapstructure:"test_phones" json:"test_phones" yaml:"test_phones"`                                              // 测试手机列表
	...
	PublishingPayChannelId  int64    `mapstructure:"publishing_pay_channel_id" json:"publishing_pay_channel_id" yaml:"publishing_pay_channel_id"`    // 发行默认充值渠道ID
